ServerEvents.highPriorityData(event => {
    ...
    addMeteor('endgtores_big', 12, { "item": "gtceu:uranium_rhodium_dinaquadide_block" }, 6, "minecraft:end_stone", endMap, 500)
    addMeteor('nethergtores_big', 16, { "item": "gtceu:indium_tin_barium_titanium_cuprate_block" }, 8, "minecraft:netherrack", netherMap, 250)
    addMeteor('overworldgtores_big', 16, { "item": "gtceu:samarium_iron_arsenic_oxide_block" }, 8, "minecraft:cobblestone", overworldMap, 125)
    addMeteor('allthemodium_big', 12, { "item": "allthemodium:unobtainium_vibranium_alloy_block" }, 6, "allthemodium:ancient_stone", atmMap, 500)
    addMeteor('palladium_big', 12, { "item": "gtceu:rhodium_plated_palladium_block" }, 6, "minecraft:end_stone", palladiumMap, 500)
})