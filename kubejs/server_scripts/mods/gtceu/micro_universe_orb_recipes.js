...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.micro_universe_collector('otherworldy_ore')
        .itemInputs('16x kubejs:micro_universe_catalyst', '1x kubejs:micro_universe_drill_ship', '16x #forge:ingots/uranium')
        .inputFluids(Fluid.of('gtceu:rocket_fuel', 10000), Fluid.of('gtceu:nether_star', 144 * 16))
        .itemOutputs('288x gtceu:neutronium_nugget', '126x allthemodium:allthemodium_nugget', '126x allthemodium:unobtaimium_nugget', '126x gtceu:naquadria_nugget')
    ...
    event.recipes.gtceu.micro_universe_collector('end_ore')
        ...
        .circuit(1)
        .inputFluids(Fluid.of('gtceu:rocket_fuel', 10000), Fluid.of('gtceu:end_air', 1000000), Fluid.of('gtceu:nether_star', 144 * 64))
    ...
    event.recipes.gtceu.micro_universe_collector('nether_ore')
        ...
        .itemOutputs('256x gtceu:nether_sulfur_ore', '256x gtceu:nether_tetrahedrite_ore', '128x gtceu:nether_sphalerite_ore', '128x gtceu:nether_gold_ore')
    ...
    event.recipes.gtceu.micro_universe_collector('overworld_ore')
        ...
        .itemOutputs('320x gtceu:copper_ore', '256x gtceu:tin_ore', '128x gtceu:iron_ore', '16x alltheores:allthemodium_ore')
    ...
    event.recipes.gtceu.micro_universe_reactor('uev_power')
        .itemInputs('16x kubejs:micro_universe_catalyst', '1x kubejs:micro_universe_drill_ship', '256x gtceu:tritium_ingot', '128x gtceu:neutronium_ingot', '1x #forge:batteries/uhv')
        .circuit(2)
        .inputFluids(Fluid.of('gtceu:nether_star', 144 * 16))
